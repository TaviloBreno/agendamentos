...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">
            <i class="fas fa-edit mr-1"></i>Editar Dados do Cliente
        </h6>
    </div>
    <div class="card-body">
        <form action="<?= route_to('super.clients.update', $client->id) ?>" method="POST">
            <?= csrf_field() ?>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control phone-mask" id="phone" name="phone" 
                               value="<?= old('phone', $client->phoneFormatted()) ?>" placeholder="(00) 00000-0000">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control cpf-mask" id="cpf" name="cpf" 
                               value="<?= old('cpf', $client->cpfFormatted()) ?>" placeholder="000.000.000-00">
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        if ($birthDate && is_object($birthDate)) {
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control cep-mask" id="zip_code" name="zip_code" 
                               value="<?= old('zip_code', $client->zipCodeFormatted()) ?>" placeholder="00000-000">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
