...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">
            <i class="fas fa-concierge-bell mr-2"></i>Dados do Serviço
        </h6>
    </div>
    <div class="card-body">
        
        <?= form_open(route_to('super.services.create'), ['class' => 'needs-validation']) ?>
                    ...
                    <div class="form-group">
                        ...
                        >
                            ...
                            <?php foreach ($durationOptions as $value => $label): ?>
                                <option value="<?= $value ?>" <?= old('duration') == $value ? 'selected' : '' ?>>
                                    <?= esc($label) ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
